...
public class ApiDemo {
    ...
    public static final String TAG = "ApiDemo";
     ...
     * Constructor.
     */
    public ApiDemo(Context context, Toast toast, AlertDialog dialog) {
...
//            dialog.getWindow().setType(WindowManager.LayoutParams.TYPE_KEYGUARD_DIALOG);
     ...
     * Show dialog by resource id.
     */
    public void showDialog(DialogInterface.OnDismissListener dismissListener, int resId) {
        dialog.setOnDismissListener(dismissListener);
        showDialog(resId, true);
    }

    public void showDialog(DialogInterface.OnDismissListener dismissListener, String message) {
        dialog.setOnDismissListener(dismissListener);
