...
//
//
//public class DemoFragment extends Fragment implements View.OnClickListener, OnTaskCompleted {
...
//    private TextView tv_status_scan, tv_noitem, scanqr, scanqr_wechat, tv_wechat_qr_scan_cv, tv_unionpay_qr_cv, scanqr_unionpay, tv_enable_payment, edt_xmpp_amount, edt_xmpp_amount1, tv_alipay, tv_wechat;
...
//            convenience_amount_uplan = 0.0, convenience_amount_unionpayqrscan = 0.0, convenience_amount_unionpayqrdisplay = 0.0;
...
//    TextView tv_uni_cv, tv_uni_cv1_uplan, tv_uni_cv2_scan_qr, tv_ali_cv, tv_ali_cv1, tv_ali_cv2;
...
//        tv_wechat_scan_disabled = view.findViewById(R.id.tv_scanqr_wechat_disabled);
//
//
...
//                tv_unionpay_qr_cv.setText(preferenceManager.getcnv_uniqr());
//            } else {
//                tv_unionpay_qr_cv.setVisibility(View.INVISIBLE);
...
//            scanqr_wechat.setVisibility(View.VISIBLE);
...
//                                if (DemoFragment.isUpayselected)
...
//        scanqr_wechat = view.findViewById(R.id.scanqr_wechat);
//        scanqr_unionpay = view.findViewById(R.id.scanqr_unionpay);
//        tv_unionpay_qr_cv = view.findViewById(R.id.tv_unionpay_qr_cv);
//        tv_wechat_qr_scan_cv = view.findViewById(R.id.tv_wechat_qr_scan_cv);
//
...
//            scanqr_wechat.setVisibility(View.INVISIBLE);
//        } else if (!preferenceManager.isAlipaySelected() &&
//                !preferenceManager.isWechatSelected() &&
//                preferenceManager.isAlipayScan() &&
//                preferenceManager.isWeChatScan()) {
...
//        scanqr_wechat.setOnClickListener(this);
...
//                        (1 - (Double.parseDouble(preferenceManager.getcnv_wechat()) / 100));
//                tv_wechat_qr_scan_cv.setText("" + roundTwoDecimals(convenience_amount_wechat_scan));
//            }
//
//        }
////        if (preferenceManager.isAlipayScan() && preferenceManager.isWeChatScan() && (preferenceManager.is_cnv_alipay_display_and_add() ||
////                preferenceManager.is_cnv_alipay_display_only())) {
////            tv_ali_cv2.setText("A:" + roundTwoDecimals(convenience_amount_alipay_scan) + " | " +
////                    "W:" + roundTwoDecimals(convenience_amount_wechat_scan));
////        }
//
//    }
//
...
//                            DemoFragment.val = jsonObject.toString();
//                        } else {
//                            preferenceManager.setunion_pay_resp(jsonObject.toString());
//                            DemoFragment.val = jsonObject.toString();
//                        }
