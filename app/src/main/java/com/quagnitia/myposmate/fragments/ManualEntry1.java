...
public class ManualEntry1 extends Fragment implements View.OnClickListener, OnTaskCompleted {
    ...
    public static ManualEntry1 newInstance(String param1, String param2) {
        ManualEntry1 fragment = new ManualEntry1();
...
//                            ((DashboardActivity) getActivity()).callSetupFragment(DashboardActivity.SCREENS.ManualEntry1, null);
//                        } else {
                    ...
                    if (intent.hasExtra("identityCode")) {
                        ...
                        if (MyPOSMateApplication.isOpen) {
                            if (preferenceManager.isConvenienceFeeSelected()) {
                                if (ManualEntry1.isUpayselected)
        ...
        if (jsonObject.has("responseCodeThirtyNine")) {
            if (jsonObject.has("responseCodeThirtyNine") && jsonObject.optString("responseCodeThirtyNine").equals("00")) {
                ...
                if (isunionPayQrScanSelectedForSale) {
                    ...
                    ManualEntry1.val = jsonObject.toString();
                } else {
                    preferenceManager.setunion_pay_resp(jsonObject.toString());
                    ManualEntry1.val = jsonObject.toString();
                }
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                if (MyPOSMateApplication.isOpen) {
                                    ...
                                    AppConstants.xmppamountforscan = "";
                                    isTriggerCancelled = true;
                                    ManualEntry1.isUpayselected = false;
                                    if (isTriggerCancelled) {
                                        isTrigger = false;
                                        callAuthToken();
                                    }
                                    ...
                                    if (!AppConstants.xmppamountforscan.equals("")) {
                                        ...
                                        handler.postDelayed(new Runnable() {
                                            ...
                                            public void run() {
                                                ...
                                                } else if (ManualEntry1.isUnionPayQrSelected) {
                                                    AppConstants.isScannedCode1 = false;
